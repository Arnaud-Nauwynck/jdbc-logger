 ...
 */
public class JdbcLoggerCallableStatement extends JdbcLoggerPreparedStatement implements CallableStatement {

    /** redondant with ((CallableStatement)super.to) */
    protected final CallableStatement to;

    // constructor
    // --------------------------------------------------------------------------------------------

    public JdbcLoggerCallableStatement(JdbcLoggerConnection owner, CallableStatement to, String sql) {
        super(owner, to, sql);
        this.to = to;
    }

    public JdbcLoggerCallableStatement(JdbcLoggerConnection owner,
    ...
    public <T> T getObject(int parameterIndex, Class<T> type) throws SQLException {
        T res;
        try {
            res = to.getObject(parameterIndex, type);
            fillOutRes(parameterIndex, res);
        } catch (SQLException ex) {
            fillOutEx(parameterIndex, ex);
            throw ex;
    ...
    public <T> T getObject(String parameterName, Class<T> type) throws SQLException {
        T res;
        try {
            res = to.getObject(parameterName, type);
