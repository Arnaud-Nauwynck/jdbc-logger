...
public class JdbcLoggerResultSet implements ResultSet {

	protected ResultSet to;
	protected StatementLog owner;

	// ------------------------------------------------------------------------
	
	public JdbcLoggerResultSet(StatementLog owner, ResultSet to) {
		this.owner = owner;
		this.to = to;
	}
	...
	public boolean next() throws SQLException {
		...
		try {
			...
			owner.getCallInfo().incrResultSetNext(time);
		}
		return res;
	}
